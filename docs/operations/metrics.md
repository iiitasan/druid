...
|`query/quota`| Assigned lane and priority. Only if Laning strategies is enabled. Refer to [Laning strategies](../configuration/index.html#laning-strategies)| lane, dataSource, type
